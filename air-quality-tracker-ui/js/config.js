 ...
 * - AWS Production: Use http://YOUR_EC2_IP:8080/api (for deployed application)
 * 
 * Note: Ensure backend API is running before starting the UI
 */
const CONFIG = {
    // API Base URL - Toggle between local and AWS
    // API_BASE_URL: 'http://YOUR_EC2_IP:8080/api',  // AWS Production
    API_BASE_URL: 'http://localhost:8080/api',        // Local Development
    
    // Swagger UI URL - Toggle between local and AWS
    // SWAGGER_UI_URL: 'http://YOUR_EC2_IP:8080/swagger-ui/index.html'  // AWS Production
